    ...
    try {
      ...
      if (data.success) {
        ...
        Swal.fire({
          ...
          timer: 2000,
          background: '#ffffff',
          iconColor: '#ffbb00', // Matches secondary gold
          customClass: {
      ...
      Swal.fire({
        ...
        text: 'The vault is currently inaccessible. Please try again later.',
        confirmButtonColor: '#1e1e1e',
      });
    } finally {
      setLoading(false);
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 pt-20 px-6">
      <div className="max-w-md w-full bg-white p-10 rounded-2xl shadow-2xl border border-gray-100">
        <div className="text-center mb-10">
          ...
          <p className="text-primary/50 text-sm">Access your personalized collection & orders</p>
        </div>
